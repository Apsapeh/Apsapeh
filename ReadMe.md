...
- **HateEngineRuntime** — modern game engine for old PCs, written in pure C99. WIP, currently suspended.
- **ITMO-SCAC** — study project: my own programming language, compiler, ISA, and CPU simulator. Code quality is shit, be carefull.
